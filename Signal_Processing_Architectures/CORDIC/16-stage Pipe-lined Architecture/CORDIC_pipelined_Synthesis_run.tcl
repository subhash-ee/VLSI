#to get into yosys use "yosys -l run.log"
#to run entire process write all commands in tcl file and run using command "script filename.tcl"
...
write_verilog -noattr CORDIC_Pipelined_gate_level.v

#Write design to BLIF file

#write_blif -buf BUF_X2 A Z CORDIC_ROLL_gate_level_mapped_withbuf.blif

#generate schematics using graphviz

show -stretch

#show -format dot -prefix my_design
